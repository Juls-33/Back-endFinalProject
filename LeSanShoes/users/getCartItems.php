...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "SELECT c.cart_id, c.quantity, c.total_price, s.size_name, cm.colorway_name, cs.colorway_size_id, cs.stock, cm.colorway_id, cm.price, cm.image1, sm.model_name
            FROM cart_tbl c
